...
<img src="./img/outernetgraphic-300x139.png" width=600 lign="center" />
...
Por otra parte ya **había pasado más de una año** tras completarse la campaña en Indiegogo y el proyecto **se replantea el segmento espacial**. Que había pasado, de pensar en una constelación de micro-satélites propios en órbita baja (LEO) construidos por la empresa escocesa Clyde Space. A contratar un transpondedor de un satélite geostacionario. Finalmente llegaron a un acuerdo con ViaSat para el uso de un _beam_ que empezó con 20MB por día de _uplink_ desde el satélite SkyTerra-1 en banda L. Lo que garantizaba la recepción con antenas pequeñas. 
</br>
